...
export const THEMES = {
  ...
  dark: {
    ...
    vars: {
      ...
      "--color-accent": "#ec3013",
      "--color-accent-100": "#241110",
      "--color-accent-200": "#331512",
      "--color-accent-300": "#4d1d16",
      "--color-accent-400": "#b1341d",
      "--color-accent-500": "#ec3013",
      "--color-accent-600": "#d13a20",
      "--color-accent-700": "#f2705a",
      "--color-accent-800": "#f7a795",
      "--color-accent-900": "#fbc9be",
