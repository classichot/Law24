...
const FNS: Fn[] = [
  ...
  { mode: "assemble", screen: "asm", w: 3, playbook: "assembly", type: "assemble", keys: ["clause", "conflict", "thai law", "ประกอบ", "ข้อสัญญา", "กฎหมายไทย", "อนุญาโต", "live draft", "ร่างสด", "ปรับข้อ"], label: P("ร่างสด", "Live draft"), why: P("ดูร่างของประเภทที่เลือก แล้วปรับทีละข้อ", "See the selected type's draft and adjust clause by clause") },
  ...
  { mode: "holistic", screen: "cockpit", w: 5, playbook: "decision", type: "review", keys: ["cockpit", "command center", "stage", "value", "ห้องบังคับ", "มูลค่า", "ขั้นสัญญา"], label: P("Contract Cockpit", "Contract Cockpit"), why: P("เห็นทั้งฉบับเป็นห้องบังคับก่อนบันทึก", "See the whole instrument as a cockpit before the memo") },
  { mode: "holistic", screen: "dna", w: 4, playbook: "decision", type: "review", keys: ["dna", "clause dna", "house standard", "ข้อมาตรฐาน", "เทียบประวัติ"], label: P("Clause DNA", "Clause DNA"), why: P("เทียบข้อนี้กับเพลย์บุ๊กและฉบับที่ลงนามแล้ว", "This clause versus playbook and signed history") },
  { mode: "holistic", screen: "hinter", w: 3, playbook: "decision", type: "review", keys: ["interact", "conflict between", "whole", "holistic", "ปฏิสัมพันธ์", "ข้อขัดกัน", "ทั้งฉบับ"], label: P("ปฏิสัมพันธ์ระหว่างข้อ", "Clause interaction"), why: P("ข้อสัญญาไม่ได้ทำงานทีละข้อ", "Clauses do not operate alone") },
  { mode: "holistic", screen: "simulate", w: 4, playbook: "decision", type: "review", keys: ["what if", "simulate", "exposure", "delay", "จำลอง", "ถ้าเกิด", "ความเสี่ยงสูงสุด"], label: P("จำลองผลของสัญญา", "Consequence simulator"), why: P("ถามผลจริงก่อนออกบันทึก", "Ask real outcomes before the memo") },
  { mode: "holistic", screen: "memo", w: 5, playbook: "decision", type: "review", keys: ["memo", "board pack", "management", "recommend", "sign or not", "บันทึก", "ผู้บริหาร", "ลงนามได้หรือไม่", "คำแนะนำ"], label: P("บันทึกตัดสินใจ", "Decision memo"), why: P("ท่าทีชัด: ลงนาม เจรจาใหม่ หรือปฏิเสธ", "A clear posture: sign, renegotiate or reject") },
  { mode: "diligence", screen: "deal", w: 6, playbook: "dd", type: "diligence", keys: ["deal x-ray", "x-ray ดีล", "ทั้งธุรกรรม", "whole deal", "diligence os"], label: P("Deal X-Ray", "Deal X-Ray"), why: P("จอเดียวว่าอะไรฆ่าหรือหน่วงดีล", "One screen for what can kill or hold the deal") },
  { mode: "diligence", screen: "dmatter", w: 3, playbook: "dd", type: "diligence", keys: ["m&a", "buy-side", "acquisition", "target", "ic ", "deal", "ซื้อกิจการ", "ฝั่งผู้ซื้อ", "เป้าหมาย", "คณะกรรมการลงทุน"], label: P("ธุรกรรม", "Transaction"), why: P("ล็อกประเภทธุรกรรมก่อนสร้างรายการตรวจ", "Lock the transaction type before the checklist is born") },
  ...
  { mode: "diligence", screen: "dmiss", w: 6, playbook: "dd", type: "diligence", keys: ["missing", "should exist", "ไม่ครบ", "เอกสารที่ขาด", "should have"], label: P("เอกสารที่ขาด", "Missing documents"), why: P("สิ่งที่ควรมีแต่ยังไม่ถูกส่ง", "What should exist but was not provided") },
  { mode: "diligence", screen: "dcontra", w: 5, playbook: "dd", type: "diligence", keys: ["contradict", "inconsist", "ข้อขัดแย้ง", "ไม่ตรงกัน", "cap table"], label: P("ข้อขัดแย้ง", "Contradictions"), why: P("ข้อเท็จจริงที่ขัดกันข้ามเอกสาร", "Facts that conflict across documents") },
  { mode: "diligence", screen: "dbreak", w: 5, playbook: "dd", type: "diligence", keys: ["red flag", "kill", "deal breaker", "change of control", "facility", "ธงแดง", "ล้มดีล", "อำนาจควบคุม", "สินเชื่อ"], label: P("ข้อที่อาจฆ่าดีล", "Deal breakers"), why: P("รายการที่ผู้ตัดสินใจต้องเห็นก่อน", "The list decision-makers need first") },
  { mode: "diligence", screen: "dsim", w: 5, playbook: "dd", type: "diligence", keys: ["simulate", "asset deal", "49%", "structure", "จำลอง", "ซื้อสินทรัพย์", "โครงสร้าง"], label: P("จำลองโครงสร้าง", "Impact simulator"), why: P("เปลี่ยนโครงสร้างแล้วดูความเสี่ยงใหม่", "Change the structure and watch exposure move") },
  { mode: "diligence", screen: "dfix", w: 5, playbook: "dd", type: "diligence", keys: ["fix", "remediate", "consent", "amendment", "แก้ไข", "ยินยอม", "ฉบับแก้ไข"], label: P("แก้ไข", "Remediate"), why: P("จากข้อค้นพบสู่ฉบับแก้ไขหรือความยินยอม", "From a finding to an amendment or consent") },
  { mode: "diligence", screen: "dflags", w: 4, playbook: "dd", type: "diligence", keys: ["related party", "บุคคลเกี่ยวโยง", "risk engine"], label: P("ความเสี่ยง", "Risk"), why: P("ประเด็นหลายมิติพร้อมสมมติฐาน", "Multi-dimension issues with assumptions") },
  ...
  { mode: "intel", screen: "twin", w: 6, playbook: "memory", type: "review", keys: ["twin", "living legal", "ฝาแฝด", "ask the company", "uncapped how many", "ถามทั้งพอร์ต"], label: P("Living Legal Twin", "Living Legal Twin"), why: P("ถามตำแหน่งกฎหมายขององค์กรนี้ — ต้องมีต้นทาง", "Ask this company's legal position — it must trace to source") },
  { mode: "intel", screen: "ipf", w: 3, playbook: "memory", type: "review", keys: ["portfolio", "how many", "estate", "uncapped liability", "พอร์ต", "ทั้งองค์กร", "ไม่จำกัดกี่ฉบับ"], label: P("ภาพรวมพอร์ต", "Contract portfolio"), why: P("ความเสี่ยงสะสมทั้งองค์กร", "Concentrated risk across the estate") },
  { mode: "intel", screen: "ikg", w: 2, playbook: "memory", type: "review", keys: ["graph", "which contracts", "กราฟ", "โยง"], label: P("กราฟความรู้", "Legal knowledge graph"), why: P("เดินสายจากคู่สัญญาหรือข้อไม่จำกัด", "Walk a chain from a party or an uncapped node") },
  { mode: "intel", screen: "memory", w: 2, playbook: "memory", type: "review", keys: ["memory", "exception", "what did we accept", "ความจำ", "ข้อยกเว้น", "เคยยอม"], label: P("ความจำทางกฎหมาย", "Legal memory"), why: P("ข้อยกเว้นและผลเจรจาที่เคยยอมในเทนแนนท์นี้", "Exceptions and outcomes already accepted in this tenant") },
  { mode: "command", screen: "desk", w: 5, playbook: "command", type: "review", keys: ["command", "control", "legal request", "gc desk", "ศูนย์บัญชาการ", "คำขอกฎหมาย", "ควบคุม"], label: P("ศูนย์บัญชาการกฎหมาย", "Legal command center"), why: P("คำขอ อนุมัติ ที่ปรึกษาภายนอก และรายงานกรรมการ", "Requests, approvals, outside counsel and board reports") },
  { mode: "command", screen: "approvals", w: 4, playbook: "command", type: "review", keys: ["approval", "dpo gate", "อนุมัติ", "ด่าน"], label: P("การอนุมัติ", "Approvals"), why: P("ด่าน DPO ของนิมบัสยังค้าง", "The Nimbus DPO gate is still pending") },
  { mode: "practice", screen: "brain", w: 5, playbook: "practice", type: "review", keys: ["brain", "precedent", "firm knowledge", "สมอง", "บรรทัดฐาน", "คลังความรู้"], label: P("สมองสำนักงาน", "Firm Brain"), why: P("จูเนียร์ใช้ความรู้หุ้นส่วนโดยไม่เปิดข้ามลูกค้า", "Juniors use partner knowledge without crossing clients") },
  { mode: "practice", screen: "room", w: 5, playbook: "practice", type: "review", keys: ["client room", "white label", "portal", "ห้องตรวจ", "ลูกค้าอนุมัติ", "แบรนด์สำนักงาน"], label: P("ห้องตรวจลูกค้า", "Client Review Room"), why: P("ลูกค้าอนุมัติคำแนะนำภายใต้แบรนด์สำนักงาน", "The client approves recommendations under the firm brand") },
  { mode: "practice", screen: "packages", w: 4, playbook: "practice", type: "review", keys: ["package", "productiz", "fixed fee", "บริการสำเร็จรูป", "ค่าธรรมเนียมคงที่"], label: P("บริการสำเร็จรูป", "Packaged services"), why: P("ขายงานเป็นสินค้า — แล้วออกใบเสนอ", "Sell the work as a product — then issue the quote") },
  { mode: "practice", screen: "quote", w: 4, playbook: "practice", type: "review", keys: ["quote", "engagement", "letter", "ใบเสนอ", "หนังสือว่าจ้าง"], label: P("ใบเสนอและหนังสือว่าจ้าง", "Quote & engagement"), why: P("สร้างหนังสือว่าจ้าง — ทนายเป็นผู้ลงนามในท่าที", "Generate the engagement letter — counsel signs the posture") },
  { mode: "practice", screen: "assign", w: 3, playbook: "practice", type: "review", keys: ["assignment", "matter open", "instruction", "เปิดงาน", "รับงาน", "คำสั่ง"], label: P("งาน", "Assignments"), why: P("เปิดงานใต้ลูกค้า มีหัวหน้าและกำหนด", "Open the assignment under a client, with lead and due date") },
  { mode: "practice", screen: "trace", w: 3, playbook: "practice", type: "review", keys: ["trail", "trace", "audit", "from start", "เส้นทาง", "ไล่งาน", "ต้นถึงจบ"], label: P("เส้นทางงาน", "Movement trail"), why: P("ฝ่ายบริหารไล่จากคำสั่งแรกถึงจุดควบคุมปัจจุบัน", "Management reads intake through the current control") },
  { mode: "help", screen: "use", w: 5, playbook: "help", type: "review", keys: ["how to", "help", "ใช้ระบบ", "คู่มือ", "วิธีใช้", "platform", "onboard"], label: P("วิธีใช้ LAW24", "How to use LAW24"), why: P("อ่านหลักของระบบก่อนลงมือในเครื่องยนต์", "Read the OS rules before work in the engine") },
  { mode: "help", screen: "leio", w: 6, playbook: "help", type: "review", keys: ["leio", "เลโอ", "bot", "assistant", "ผู้ช่วย ai"], label: P("เลโอ", "Leio"), why: P("ถามวิธีใช้ วิจัย และกฎ — ทุกข้อมีหลักฐาน", "Ask how to use, research and regulation — every answer cites evidence") },
  { mode: "help", screen: "watch", w: 5, playbook: "help", type: "review", keys: ["research", "regulation", "วิจัย", "กฎ", "gazette", "ประกาศ", "pdpc", "สคส", "update"], label: P("วิจัยและกฎ", "Research & regulations"), why: P("งานวิจัยสั้นและกฎที่เลโอติดตามในเทนแนนท์นี้", "Short research and the regulations Leio is watching in this tenant") },
  { mode: "help", screen: "books", w: 5, playbook: "help", type: "review", keys: ["playbook", "เพลย์บุ๊ก", "house position", "นโยบายบ้าน", "house book"], label: P("คลังเพลย์บุ๊ก", "Playbook library"), why: P("เปิดเล่มที่ใช้บังคับกับงานนี้", "Open the volume in force on this work") },
];
