...
const JOBS: { keys: string[]; read: TE; boost: Partial<Record<Exclude<ModeKey, "home">, number>> }[] = [
  { keys: ["gc", "general counsel", "in-house", "ที่ปรึกษากฎหมายประจำ", "องค์กร", "in house"], read: P("ที่ปรึกษากฎหมายประจำองค์กร — คุมความเสี่ยงพอร์ตและฉบับคู่สัญญา", "In-house counsel — portfolio risk and counterparty paper"), boost: { review: 6, obligations: 5, intel: 4, assemble: 2, holistic: 2 } },
