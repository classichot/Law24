...
export const FIRM_CONTROL: FirmControlHop[] = [
  ...
  { href: "/assemble?s=asm", en: "Live draft", th: "ร่างสด", kind: "engine", track: "assemble", why: { t: "ดูร่างของประเภทที่เลือก แล้วปรับทีละข้อก่อนดาวน์โหลด เครื่องยนต์ไม่ลงนาม", e: "See the selected type's draft. Adjust a clause before you download. The engine never signs." } },
